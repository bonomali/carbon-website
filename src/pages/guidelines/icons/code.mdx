...
##carbon icons for Infopowerbd
title: Carbon icons for Infopowerbd:
  Icons are visual symbols used to represent ideas, objects, or actions. They
  communicate messages at a glance, afford interactivity, and draw attention to
  important information.
...
Carbon icons for infopowerbd are provided through a set of packages allowing the use of icons in
...
<MdxIcon name="bee" />
  ...
  <Column colMd={4} colLg={4} noGutterSm>
    <ResourceCard
      subTitle="Icon package for infopower"
      href="https://github.com/carbon-design-system/carbon/blob/v10/packages/icons"
    >
